...
vec4 v_screenPos : TEXCOORD3  = vec4(0.0, 0.0, 0.0, 0.0);
vec4 v_cs_pos	 : TEXCOORD4  = vec4(0.0, 0.0, 0.0, 0.0);
vec2 v_ss_tex	 : TEXCOORD5  = vec2(0.0, 0.0);
vec2 v_ray		 : TEXCOORD6  = vec2(0.0, 0.0);
